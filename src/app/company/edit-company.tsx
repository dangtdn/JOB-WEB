...
const EditCompany = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      locationLatitude: data?.locationMap.latitude,
      locationLongitude: data?.locationMap.longitude,
      videoLink: data?.videoLink,
      linkedinLink: data?.socialLink.linkedin,
      facebookLink: data?.socialLink.facebook,
      twitterLink: data?.socialLink.twitter,
      headerImage: "",
