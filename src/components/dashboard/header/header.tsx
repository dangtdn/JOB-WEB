						...
						<div className="hidden lg:flex items-center justify-center">
							<ul className="flex items-center space-x-6 mr-6">
								<li className="relative !p-1 grid items-center">
									<button
										className={`text-themeDark relative hover:text-themePrimary ${notification ? '!text-themePrimary' : ''
											}`}
								...
								<div className="relative">
									{user?.data && (
										<div
											...
											<span
												className={`ml-2 transition duration-200 ease-in-out ${UserMenu ? 'rotate-180' : ''
													}`}>
												<HiChevronDown />
											</span>
										</div>
