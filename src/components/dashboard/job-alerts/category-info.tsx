    ...
    <section className="mb-6">
      ...
      {categoryData && (
        <>
          ...
          <div
            className={`shadow rounded-lg mb-10 overflow-x-auto overflow-y-hidden hidden md:block relative`}
          >
...
const TableItem = ({
  ...
  return (
    <tr className="border-b border-themeLighter w-full align-top last-of-type:border-none">
