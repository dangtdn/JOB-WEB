						...
						<div className="!mx-5 xl:mx-10 justify-center items-center">
								...
								<div className="flex flex-wrap">
									...
									<div className="w-full md:w-3/6 px-3 md:py-2">
										...
										<input
											...
											} border rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
											id="grid-first-name"
											type="text"
									...
									<div className="w-full md:w-3/6 px-3 md:py-2">
										...
										{/* <Form.Select
                                            ...
                                            className={`appearance-none block w-full text-themeDark ${errors?.region ? "!border-red-400" : ""
                                                } border rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
                                            // defaultValue={resumeData?.region}
									...
									<div className="w-full md:w-3/6 px-3 md:py-2">
										...
										<div className="mt-2 border border-themeLighter rounded py-1 !px-3">
											{photoImage && (
											...
											<div className="flex gap-4 items-center">
												<label
													className="block text-xss1 duration-300 ease-in-out py-1 px-3 border border-themeLighter shadow-sm cursor-pointer hover:bg-green-200 hover:border-green-200 text-themeLight rounded"
													htmlFor="photoImage">
													Select File
													<input
														className="hidden"
									...
									<div className="w-full md:w-3/6 px-3 md:py-2">
										...
										{/* <Form.Select
                                            aria-label="Default select example"
                                            className={`appearance-none block w-full text-themeDark ${errors?.category ? "!border-red-400" : ""
                                                } border rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
                                            defaultValue={""}
                                            {...register("category", {
                                                required: true,
										...
										{/* <MultiSelect
                                            ...
                                            selectedValues={[resumeData?.category]}
                                            isObject={false}
                                            validationSyntax={true}
									...
									<div className="w-full px-3 md:py-2">
										...
										<textarea
											...
											} border  focus:outline-none focus:bg-white mt-2 p-3 rounded`}
									...
									<div className="w-full md:w-3/6 px-3 md:py-2">
										...
										<div className="border border-gray rounded p-2">
											{urls.map((url, index) => (
												<div
													className="p-8 !mx-5 mt-3 mb-7 transition-all duration-300 ease-in-out bg-green-100 border rounded-lg shadow relative"
													key={url.id}>
													<div className="!mb-3">
														<label
											...
											<button
												type="button"
												onClick={() =>
													urlsAppend({ id: urls.length + 1, url: '', name: '' })
												}
												className="!px-3 py-1.5 flex items-center justify-between gap-2 bg-green-100  shadow-sm hover:bg-green-300 transition-all duration-300 ease-in-out text-themeLight rounded text-xss1">
												Add URL <GoPlus />
											</button>
										</div>
									</div>
											...
											{educations.map((education, index) => (
												<div
													...
													<div className="!mb-3">
														...
														<textarea
															className="h-28 appearance-none block w-full text-themeDark border rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white"
															id="grid-notes"
							...
							<div className="mt-6 px-3 !pb-5">
								<button
									...
									} rounded-lg shadow shadow-themePrimary text-white font-medium text-xs`}>
