...
const EditPackageForm = () => {
	...
	return (
		<section className="mb-6">
			<div className="shadow rounded-xl relative overflow-auto">
				...
				<div className="mx-auto py-10 px-6 lg:px-8 relative">
					...
					{!error && (
						<form onSubmit={handleSubmit(onSubmit)}>
							<div className="grid lg:grid-cols-2 grid-cols-1 sm:grid-cols-1 gap-4 border-b border-themeLighter pb-10 mb-10">
								{/* Title */}
								<div>
									...
									<input
										...
										className={`w-full border-1 ${
											errors?.Title ? '!border-red-400' : 'border-themeLighter'
                          ...
                          >
                            Add Pricing Plan
									...
									<div className="grid lg:grid-cols-2 grid-cols-1 gap-4 !mb-4">
										<div>
											...
											<input
												...
												className={`w-full border-1 border-themeLighter focus:right-0 focus:outline-0 rounded-lg !px-4 !py-2`}
											/>
										</div>
										<div>
											<div>
									...
									<div className="border-b border-themeLighter pb-6 mb-10">
