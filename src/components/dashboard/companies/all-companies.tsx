...
import { AiOutlineEdit, AiOutlineEye, AiOutlineMail } from "react-icons/ai";
...
const AllCompanies = () => {
  ...
  // rejected company function here
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap gap-3 items-center justify-between mb-3">
        <span className="text-themeDark bg-green-200 rounded-lg font-semibold px-3 py-1 text-sm">
          {date}
        </span>
