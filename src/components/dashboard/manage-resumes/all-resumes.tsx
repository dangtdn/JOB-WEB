...
const TableItem = ({
  ...
  return (
    ...
    >
      ...
      <td className="text-themeDark text-base  px-3 py-4 align-middle">
        <span className="text-themeDark whitespace-nowrap bg-green-200 rounded-lg font-semibold px-3 py-1 text-sm">
          {date}
        </span>
      </td>
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap justify-between mb-3">
        <div className="text-themeDark text-xss1 bg-green-200 rounded-lg px-3 py-1.5 inline-block">
          {date}
        </div>
      ...
      <div className="flex flex-wrap gap-3 mt-3">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/resume/edit-resume?active_id=${item._id}`} passHref>
            <div className="bg-green-200 shadow-sm flex gap-2 py-2 px-3 items-center justify-center rounded-lg">
