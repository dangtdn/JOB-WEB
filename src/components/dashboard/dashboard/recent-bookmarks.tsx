              ...
              {_.map(
                ...
                (bookmark: any, index: number) => (
                  <div
                    onClick={() => {
                      bookmark.job
                        ? router.push(`/job/${bookmark.job?._id}`)
                        : bookmark.company
                        ? router.push(`/company/${bookmark.company?._id}`)
                        : bookmark.resume
                        ? router.push(`/resume/${bookmark.resume?._id}`)
                        : router.push(`/bookmarks`);
                    }}
                    className="block py-3 px-5 md:px-8  border-b border-gray last-of-type:border-b-0 hover:bg-themeLighterAlt cursor-pointer transition-all duration-300 ease-in-out w-full group"
                    key={index}
                  >
                          ...
                          {bookmark.job && (
                            <div>
                              <Link
                                ...
                                className="group-hover:text-themePrimary relative pr-2 line-clamp-1"
                              >
