        ...
        <form className="space-y-8" onSubmit={handleSubmit(submitHandler)}>
            ...
            <label className="w-full sm:w-1/2" htmlFor="companyName">
              ...
              <input
                className={`w-full border ${
                  errors?.companyName ? "!border-red-400" : "border-themeLight"
          ...
          <div className="pt-6">
            <button
              ...
              } text-white rounded-lg px-4 flex gap-1 items-center !py-3 shadow-xl shadow-themePrimary/25`}
            >
              {isSubmitting ? "Please wait..." : "Add Company"}
              {isSubmitting && (
