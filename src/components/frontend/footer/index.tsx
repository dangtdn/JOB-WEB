    ...
    <>
      ...
      <footer className="bg-black overflow-hidden">
        {/* <div className="container relative">
          <div className="col-span-4 md:absolute left-6 top-16 py-16 md:py-0 text-center">
            <a href="#">
              <Image
        ...
        <div className="bg-themePrimary py-8 sm:grid gap-6 lg:gap-16 items-center grid-cols-12 px-6 sm:px-10  xl:px-20 md:w-8/12 ml-auto mb-16">
          <div className="z-10 col-span-4 text-center 2xl:text-left mb-8 sm:mb-0">
            <h3 className="text-lg lg:text-xl xl:text-xxl2 text-white font-bold leading-tight">
              Subscribe <br className="hidden 2xl:block" />
              Newsletter
            </h3>
          </div>
          <div className="relative text-center 2xl:-ml-10 2xl:mr-6 col-span-7">
            <input
              type="text"
              placeholder="Enter Your Email"
              className="w-full focus:outline-none rounded-lg h-20 px-7"
            />
            <button
              className="mt-0 px-4 lg:px-8 absolute right-2 top-2 bg-black text-white rounded-md font-semibold h-16"
              type="button"
            >
              Subscribe
            </button>
