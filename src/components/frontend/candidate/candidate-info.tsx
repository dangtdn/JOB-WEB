											...
											{_.map(data?.data?.url, (item, index) => {
												return (
													<li className="mb-10 ml-4" key={index}>
														<div className="absolute z-1 w-5 h-5 bg-greenLight2 flex justify-center items-center rounded-full -left-2.5">
				...
				{loggedIn ? (
					<form
						...
						<div className="mb-6">
							...
							<textarea
								className={`appearance-none block w-full !p-3 leading-5 text-themeDarker border ${bookmarkErrors?.note ? '!border-red-500' : 'border-gray'
						...
						<button
							className={`!py-3 px-7 flex gap-2 justify-center items-center transition-all duration-300 ease-in-out mb-6 w-full text-base text-white font-normal text-center leading-6 ${bookmarkIsSubmitting ? 'bg-themeDarkerAlt' : 'bg-themePrimary'
								} rounded-md hover:bg-black`}
							type="submit"
							disabled={bookmarkIsSubmitting}>
							{bookmarkIsSubmitting ? 'Please wait...' : 'Add Bookmark'}
							{bookmarkIsSubmitting && (
								<div
			...
			<PopupModule
              ...
              >
                Select Job
							...
							<select
								className={`appearance-none block w-full !p-3 leading-5 text-themeDarker border ${errors?.job ? '!border-red-500' : 'border-gray'
              ...
              >
                Message
							...
							<textarea
								...
								className={`appearance-none block w-full !p-3 leading-5 text-themeDarker border ${errors?.message ? '!border-red-500' : 'border-gray'
						...
						<button
							className={`!py-3 px-7 flex gap-2 justify-center items-center transition-all duration-300 ease-in-out mb-6 w-full text-base text-white font-normal text-center leading-6 ${isSubmitting ? 'bg-themeDarkerAlt' : 'bg-themePrimary'
								} rounded-md ${jobApprovedFilter?.length === 0 ||
									watch('job') === '' ||
									isMessageList
